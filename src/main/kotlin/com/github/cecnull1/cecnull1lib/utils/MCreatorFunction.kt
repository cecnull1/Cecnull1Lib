...
object MCreatorFunction {
    ...
    inline fun <reified T : Entity> Level.findNearestEntity(
        ...
        ) { it !== excludeEntity }.minByOrNull { it.distanceToSqr(x, y, z) }
    }
    ...
    fun Level.findNearestEntity(
        ...
        return this.findNearestEntity(x, y, z, length, Entity::class.java, excludeEntity)
    }
    ...
    inline fun <reified T : Entity> Level.findNearestEntity(
        ...
        return this.findNearestEntity(vec3.x, vec3.y, vec3.z, length, clazz, excludeEntity)
    }
