package com.github.cecnull1.cecnull1lib.utils.changed
 ...
 * */
class TransfurData(
    val variant: TransfurVariant<*>, val keepConscious: Boolean = false, val context: TransfurContext = TransfurContext.hazard(
